...
{
	public sealed class TrackedCollection<T> : Tracked<TrackedCollection<T>.Changes>
	{
		private readonly Func<ICollection<T>> _Getter;
		private ICollection<T> _LastValue;

		public TrackedCollection(Func<ICollection<T>> getter)
		{
			_Getter = getter;
		...
		{
			public IReadOnlyCollection<T> Inserted { get; }
			public IReadOnlyCollection<T> Removed { get; }
			public IReadOnlyCollection<T> Previous { get; }

			public Changes(IReadOnlyCollection<T> inserted, IReadOnlyCollection<T> removed, IReadOnlyCollection<T> previous)
			{
