...
using static Connect3Dp.Extensions.Connect3Dp.Connect3DpWebSocketExtensions;
...
namespace Connect3Dp.Host
{
	public static class Program
	{
		public static async Task Main(string[] args)
		{
			...
			app.MapGet("/", () => new { Name = VersionInfo.RootNamespace, Version = VersionInfo.Version });

			app.Services.MapAllConnect3DpWebSocketActions();
			app.MapConnect3DpWebSocket(builder.Configuration, logger);
		...
		public static IEndpointConventionBuilder MapConnect3DpWebSocket(this IEndpointRouteBuilder routeBuilder, IConfiguration configuration, ILogger logger)
		{
			...
			return routeBuilder.MapWebSocketServer<Connect3DpWebSocketClient>(wsEndpoint);
		}
		...
		{
			var ws = services.GetRequiredConnect3DpWebSocketServer();
