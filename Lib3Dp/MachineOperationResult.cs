...
namespace Lib3Dp
{
	public readonly record struct MachineOperationResult
	{
		...
		public static MachineOperationResult Fail(string id, string title, string body, MachineMessageActions manualResolve = default, MachineMessageAutoResole autoResolve = default) => Fail(new MachineMessage(id, title, body, MachineMessageSeverity.Error, manualResolve, autoResolve));
	}

	public static class MutationResultMachineOperationResultExtensions
	{
		public static MachineOperationResult IntoOperationResult(this in MutationResult mutationResult, string operationFailedId, string operationFailedTitle, MachineMessageActions manualResolve = default, MachineMessageAutoResole autoResolve = default)
		{
			...
			return MachineOperationResult.Fail(operationFailedId, operationFailedTitle, bodyReason, manualResolve, autoResolve);
		}
		...
		/// </summary>
		public static MachineOperationResult IntoOperationResult(this MutationValuedResult<MachineOperationResult> mutationResult, string operationFailedId, string operationFailedTitle, MachineMessageActions manualResolve = default, MachineMessageAutoResole autoResolve = default)
		{
			if (mutationResult.IsSuccess) return MachineOperationResult.Ok;
