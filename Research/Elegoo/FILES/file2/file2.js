...
"polyfills.cbade4b333952df5eb42.js"
...
(self.webpackChunkcbdsa_mainboard_cmp = self.webpackChunkcbdsa_mainboard_cmp || []).push([[429], {
    7277: () => {
        "use strict";
        !function(e) {
            ...
            let a = ( () => {
                class t {
                    ...
                    runTask(e, t, n) {
                        ...
                        if (e.state === v && (e.type === O || e.type === P))
                            return;
                        const o = e.state != w;
                        ...
                        try {
                            ...
                            e.state !== v && e.state !== S && (e.type == O || e.data && e.data.isPeriodic ? o && e._transitionTo(E, w) : (e.runCount = 0,
        ...
        function S(n, o, r) {
            ...
            s.set = function(e) {
                let t = this;
                t || n !== g || (t = g),
                t && ("function" == typeof t[u] && t.removeEventListener(l, Z),
                c && c.call(t, null),
                t[u] = e,
        ...
        function C(t, o, r) {
            ...
            const i = d(o);
            let a = null;
            if (s && (!(a = s[i]) || !s.hasOwnProperty(i)) && (a = s[i] = s[o],
            T(s && e(s, o)))) {
                const e = r(a, i, o);
                s[o] = function() {
        ...
        Zone.__load_patch("ZoneAwarePromise", (e, t, n) => {
            ...
            function S(e, o, s) {
                ...
                if (e[_] === m) {
                    ...
                    if (o !== b && s instanceof I && s.hasOwnProperty(_) && s.hasOwnProperty(k) && s[_] !== m)
                        P(s),
                        S(e, s[_], s[k]);
            ...
            class I {
                    ...
                    return new I( (e, s) => {
                        for (let i = 0; i < t.length; i++)
                            ...
                            , e => {
                                ...
                                n--,
                                0 === n && (o = !0,
                                s(new z(r,"All promises were rejected")))
                            }
                            )
                    }
                    )
                ...
                static allSettled(e) {
                    return (this && this.prototype instanceof I ? this : I).allWithCallback(e, {
                        thenCallback: e => ({
                            status: "fulfilled",
                            value: e
                        }),
                ...
                then(e, n) {
                    ...
                    const s = new r(j)
                      , i = t.current;
                    return this[_] == m ? this[k].push(i, s, e, n) : O(this, i, s, e, n),
                    s
                }
                catch(e) {
                    ...
                    r[g] = g;
                    const s = t.current;
                    return this[_] == m ? this[k].push(s, r, e, e) : O(this, s, r, e, e),
                    r
                }
            }
            I.resolve = I.resolve,
        ...
        function W(e, t, o, r) {
            const a = r && r.add || s
              ...
              , g = function(e, t, n) {
                ...
                const s = e.options;
                return s && "object" == typeof s && s.once && t[c].call(t, n.type, e.originalDelegate ? e.originalDelegate : e.callback, s),
                r
            };
            function y(n, o, r) {
                if (!(o = o || e.event))
            ...
            function b(t, o) {
                ...
                const C = r ? function(e) {
                    if (!E.isExisting)
                        return w.call(E.target, E.eventName, E.capture ? m : T, E.options)
                }
                : function(e) {
                  ...
                  , j = r ? function(e) {
                    ...
                    if (e.allRemoved)
                        return Z.call(e.target, e.eventName, e.capture ? m : T, e.options)
                }
                : function(e) {
                  ...
                  , N = function(t, n, a, c, h=!1, f=!1) {
                    return function() {
                        ...
                        if (s && !s(t, _, p, arguments))
                            return;
                        const g = A && !!M && -1 !== M.indexOf(d)
                          , y = O(arguments[2], g);
                        if (R)
                            for (let e = 0; e < R.length; e++)
                                if (d === R[e])
                                    return g ? t.call(p, d, _, y) : t.apply(this, arguments);
                        ...
                        f ? P.unshift(F) : P.push(F),
                        h ? p : void 0
                    }
                };
                return y[a] = N(w, k, C, j, g),
                P && (y.prependListener = N(P, ".prependListener:", function(e) {
        ...
        function Q(e, t, n, o) {
            ...
            r = C(e, t += o, n => function(r, s) {
                if ("function" == typeof s[0]) {
                    ...
                    return "number" == typeof l ? i[l] = r : l && (l[K] = r),
            ...
            s = C(e, n, t => function(n, o) {
                const r = o[0];
                let s;
                "number" == typeof r ? s = i[r] : (s = r && r[K],
                s || (s = r)),
                s && "string" == typeof s.type ? "notScheduled" !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ("number" == typeof r ? delete i[r] : r && (r[K] = null),
        ...
        function ee(e, t) {
            ...
            return a && a.prototype ? (t.patchEventTarget(e, t, [a && a.prototype]),
            !0) : void 0
        }
        ...
        Zone.__load_patch("requestAnimationFrame", e => {
            Q(e, "request", "cancel", "AnimationFrame"),
            Q(e, "mozRequest", "mozCancel", "AnimationFrame"),
            Q(e, "webkitRequest", "webkitCancel", "AnimationFrame")
        }
        ),
