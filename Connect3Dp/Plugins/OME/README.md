# Connect3Dp Oven Media Engine Plugin

This plugin enables Connect3Dp to relay live camera feeds from supported 3D printers into Oven Media Engine streams (origins).
...
1. In Connect3Dp, configure the following environment variables: `OME_ACCESS_TOKEN` `OME_HOST_IP`.
...
docker run --name ome -d \
  ...
  -p 20080:20080 \
  -p 20081:20081 \
  -v ./Connect3Dp/Plugins/OME/origin_conf:/opt/ovenmediaengine/bin/origin_conf \
