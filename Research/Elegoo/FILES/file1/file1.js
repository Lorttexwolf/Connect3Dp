...
"runtime.87dda17ac8d018d8f5aa.js"
...
( () => {
    ...
    i.O = (r, t, a, o) => {
        if (!t) {
            ...
            for (s = 0; s < e.length; s++) {
                for (var [t,a,o] = e[s], d = !0, l = 0; l < t.length; l++)
                    (!1 & o || n >= o) && Object.keys(i.O).every(e => i.O[e](t[l])) ? t.splice(l--, 1) : (d = !1,
                    o < n && (n = o));
                d && (e.splice(s--, 1),
                r = a())
            }
    ...
    r), [])),
    i.u = e => e + "." + {
        590: "5cc05721deff5431799a",
        624: "931d12e23af9a62e6007"
    }[e] + ".js",
    i.miniCssF = e => "styles.948ae391de6d85346226.css",
    i.o = (e, r) => Object.prototype.hasOwnProperty.call(e, r),
    r = {},
    t = "cbdsa-mainboard-cmp:",
    i.l = (e, a, o, n) => {
        if (r[e])
            r[e].push(a);
        else {
            ...
            if (void 0 !== o)
                for (var s = document.getElementsByTagName("script"), u = 0; u < s.length; u++) {
                    var c = s[u];
                    if (c.getAttribute("src") == e || c.getAttribute("data-webpack") == t + o) {
                        d = c;
                        break
                    }
                }
    ...
    "undefined" != typeof trustedTypes && trustedTypes.createPolicy && (a = trustedTypes.createPolicy("angular#bundler", a))),
    a.createScriptURL(e)),
    i.p = "",
    ( () => {
        var e = {
        ...
        var r = (r, t) => {
            ...
            if (l)
                var u = l(i);
            for (r && r(t); s < n.length; s++)
                i.o(e, o = n[s]) && e[o] && e[o][0](),
                e[n[s]] = 0;
            return i.O(u)
        }
          , t = self.webpackChunkcbdsa_mainboard_cmp = self.webpackChunkcbdsa_mainboard_cmp || [];
