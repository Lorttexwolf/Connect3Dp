...
namespace Connect3Dp.SourceGeneration.UpdateGen
{
    [Generator]
    public sealed class UpdateGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            var classes = context.SyntaxProvider
                .ForAttributeWithMetadataName(
                    typeof(GenerateUpdateAttribute).FullName!,
    ...
    public sealed class GenerateUpdateAttribute : Attribute { }
